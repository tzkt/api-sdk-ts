import {blocksGet, tokensGetTokenTransfers, operationsGetTransactions} from "../src";
...
describe("request", () => {
  test('blocksGet any on in', async () => {
    const checkUrl = 'https://api.tzkt.io/v1/blocks?limit=50&anyof.producer.proposer.in=tz3WMqdzXqRWXwyvj5Hp2H7QEepaUuS7vd9K,tz3bTdwZinP8U1JmSweNzVKhmwafqWmFWRfk&level.lt=1000000'
  ...
  test('tokensGetTokenTransfers null', async () => {
    const checkUrl = 'https://api.tzkt.io/v1/tokens/transfers?limit=50&level.lt=1000000&anyof.from.to.null=true'
  ...
  test('blocksGet eq', async () => {
    const checkUrl = 'https://api.tzkt.io/v1/blocks?limit=50&anyof.proposer.producer=tz3WMqdzXqRWXwyvj5Hp2H7QEepaUuS7vd9K&level.lt=1000000'
  ...
  test('operationsGetTransactions eq', async () => {
    const checkUrl = 'https://api.tzkt.io/v1/operations/transactions?limit=50&anyof.sender.target.eq=tz3WMqdzXqRWXwyvj5Hp2H7QEepaUuS7vd9K&level.lt=1000000'
