...
export type ResponseTypes = State | Block | TezosOperation | BigMapUpdate | TokenTransfer;
export type SubscriptionParameters = OperationSubscriptionParameters | BigMapSubscriptionParameters | TokenTransferSubscriptionParameters;
